This is new product for this week.
<?php
	$categories = $this->getnewproduct;
...
<?PHP
	$pre=$startrow-4;
	if ($pre >= 0)
	echo '<a class="button" href="'.URL.'newproduct'.'?startrow='.$pre.'">Previous</a>';
?>
</n>
<?PHP
	$next=$startrow+4;
	if ($next<=count($categories))
	echo '<a class="button" href="'.URL.'newproduct'.'?startrow='.$next.'">Next</a>';
?>
