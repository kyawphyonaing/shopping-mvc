This is sepcail product for this week.
<?php
	$categories = $this->getspecialproduct;
...
<?php
	...
	echo '<p>If you want to sell your product qucikly, you contact to us. </p>';
	?>
...
<div class="prod"<?php echo $i % 2; ?>>
	...
	<p><a href="#" class="info"><?php echo htmlspecialchars($item['cat_description']); ?></a></p><br>
	<p><span><?php echo htmlspecialchars($item['remark']);?></span></p>
	</div>
	<div class="price"><?php echo htmlspecialchars($item['cat_prize']); ?></div>
	<div class="action"><br />
	<?php
	if(Session::get('loggedIn') == true){
	//echo '<p><a class="button" href="'.URL.'edit/'.$item['cat_id'].'">Edit</a></p>';
    echo '<p><a class="button" href="'.URL.'index/edit?id='.$item['cat_id'].'">Edit</a></p>';
